...
\Schema::hasColumn('emails_templates', 'models')?
	\DB::select("ALTER TABLE emails_templates MODIFY COLUMN `models` text COLLATE utf8mb4_unicode_ci"):
	\DB::select("ALTER TABLE emails_templates ADD COLUMN `models` text COLLATE utf8mb4_unicode_ci");
...
\Schema::hasColumn('teveps', 'id')?
	\DB::select("ALTER TABLE teveps MODIFY COLUMN `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT"):
	\DB::select("ALTER TABLE teveps ADD COLUMN `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT");


// Create/Update column teveps.slug
\Schema::hasColumn('teveps', 'slug')?
	\DB::select("ALTER TABLE teveps MODIFY COLUMN `slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL"):
	\DB::select("ALTER TABLE teveps ADD COLUMN `slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL");


// Create/Update column teveps.name
\Schema::hasColumn('teveps', 'name')?
	\DB::select("ALTER TABLE teveps MODIFY COLUMN `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL"):
	\DB::select("ALTER TABLE teveps ADD COLUMN `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL");


// Create/Update column teveps.created_at
\Schema::hasColumn('teveps', 'created_at')?
	\DB::select("ALTER TABLE teveps MODIFY COLUMN `created_at` datetime DEFAULT NULL"):
	\DB::select("ALTER TABLE teveps ADD COLUMN `created_at` datetime DEFAULT NULL");


// Create/Update column teveps.updated_at
\Schema::hasColumn('teveps', 'updated_at')?
	\DB::select("ALTER TABLE teveps MODIFY COLUMN `updated_at` datetime DEFAULT NULL"):
	\DB::select("ALTER TABLE teveps ADD COLUMN `updated_at` datetime DEFAULT NULL");


// Create/Update column teveps.deleted_at
\Schema::hasColumn('teveps', 'deleted_at')?
	\DB::select("ALTER TABLE teveps MODIFY COLUMN `deleted_at` datetime DEFAULT NULL"):
	\DB::select("ALTER TABLE teveps ADD COLUMN `deleted_at` datetime DEFAULT NULL");
...
\Schema::hasColumn('teveps_invites', 'id')?
	\DB::select("ALTER TABLE teveps_invites MODIFY COLUMN `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT"):
	\DB::select("ALTER TABLE teveps_invites ADD COLUMN `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT");


// Create/Update column teveps_invites.slug
\Schema::hasColumn('teveps_invites', 'slug')?
	\DB::select("ALTER TABLE teveps_invites MODIFY COLUMN `slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL"):
	\DB::select("ALTER TABLE teveps_invites ADD COLUMN `slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL");


// Create/Update column teveps_invites.name
\Schema::hasColumn('teveps_invites', 'name')?
	\DB::select("ALTER TABLE teveps_invites MODIFY COLUMN `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL"):
	\DB::select("ALTER TABLE teveps_invites ADD COLUMN `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL");


// Create/Update column teveps_invites.created_at
\Schema::hasColumn('teveps_invites', 'created_at')?
	\DB::select("ALTER TABLE teveps_invites MODIFY COLUMN `created_at` datetime DEFAULT NULL"):
	\DB::select("ALTER TABLE teveps_invites ADD COLUMN `created_at` datetime DEFAULT NULL");


// Create/Update column teveps_invites.updated_at
\Schema::hasColumn('teveps_invites', 'updated_at')?
	\DB::select("ALTER TABLE teveps_invites MODIFY COLUMN `updated_at` datetime DEFAULT NULL"):
	\DB::select("ALTER TABLE teveps_invites ADD COLUMN `updated_at` datetime DEFAULT NULL");


// Create/Update column teveps_invites.deleted_at
\Schema::hasColumn('teveps_invites', 'deleted_at')?
	\DB::select("ALTER TABLE teveps_invites MODIFY COLUMN `deleted_at` datetime DEFAULT NULL"):
	\DB::select("ALTER TABLE teveps_invites ADD COLUMN `deleted_at` datetime DEFAULT NULL");
