...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"titleTemplate":"%s - TEvEP","title":"TEvEP","link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"```bash\r npm install\r composer install\r php artisan key:generate\r php artisan jwt:secret\r php artisan storage:link\r php artisan app-deploy\r npm run dev\r ```"}],"style":[],"script":[]},
